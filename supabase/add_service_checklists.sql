-- Migration: Add quote-adjustment policy + seed service checklists with required/notIncluded
...
-- 2. Seed/update service_checklists row with required + notIncluded sections.
INSERT INTO settings (key, value)
VALUES (
  'service_checklists',
  '{
