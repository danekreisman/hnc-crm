...
*Last updated: May 1, 2026 — Janitorial leads now park in their own "Walkthrough requested" stage and "janitorial_walkthrough" segment so the Quoted→Follow-up cron and days_since_response automation skip them. Also: AI summary collapsed to a single "🚩 Things to know" section for lead/client profiles. Lead form launch checklist + custom-domain guidance added at top of Pending.*