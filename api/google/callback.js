...
module.exports = async (req, res) => {
  try {
    ...
    res.end('<!doctype html><meta charset="utf-8"><title>Google Calendar linked</title><body style="font-family:system-ui;padding:32px;max-width:560px;margin:auto;line-height:1.5"><h1 style="margin-bottom:8px">Google Calendar linked &#10003;</h1><p>Your upcoming jobs will now sync to ' + emailHtml + '. Kicking off a backfill sync for your existing jobs&hellip;</p><p style="margin-top:20px"><a href="https://calendar.google.com/calendar/u/0/r" target="_blank" style="display:inline-block;padding:10px 16px;background:#1a73e8;color:#fff;text-decoration:none;border-radius:6px;margin-right:8px">Open Google Calendar</a> <a href="/portal.html#gcal=linked" style="display:inline-block;padding:10px 16px;background:#eee;color:#000;text-decoration:none;border-radius:6px">Back to portal</a></p><p style="margin-top:16px;color:#666;font-size:13px">Redirecting you back to the portal in 2 seconds&hellip;</p><script>setTimeout(function(){ try { if (window.opener && !window.opener.closed) { window.opener.location.href = "/portal.html#gcal=linked"; window.close(); } else { window.location.href = "/portal.html#gcal=linked"; } } catch(e) { window.location.href = "/portal.html#gcal=linked"; } }, 2000);</script></body>');
  } catch (err) {
